...
function dcms_caracteristicas_producto(){
  ...
  if (function_exists('get_field')){
    ...
    echo "<p><strong>No. Serie/Vin: </strong>". get_field('no__serie_vin')."</p>";
    echo "<p><strong>Marca: </strong>". get_field('marca')."</p>";
    echo "<p><strong>Modelo: </strong>".get_field('modelo')."</p>";
    echo "<p><strong>Categoría: </strong>".get_field('categor_a')."</p>";
    echo "<p><strong>Año: </strong>". get_field('a_o')."</p>";
    echo "<p><strong><Condición: </strong>".get_field('condici_n')."</p>";
    echo "<p><strong>Motor: </strong>". get_field('motor')."</p>";
    echo "<p><strong>Horometro: </strong>". get_field('horometro')." Horas</p>";
    echo "<p><strong>Precio: </strong>". get_field('_regular_price')." USD</p>"; 
    echo "<p><strong>Información de Contacto: </strong>". get_field('informaci_n_de_contacto')."</p>";
...
function register_additional_menus() {
  register_nav_menu( 'top-menu', __( 'Abra' ) );
}
...
function Hover_add_enqueue_scripts() {
  wp_enqueue_script( 'theme_js', trailingslashit( get_stylesheet_directory_uri() ) . 'js/hover.js', array( 'jquery' ) );
}
add_action( 'wp_enqueue_scripts', 'Hover_add_enqueue_scripts' );
/**
