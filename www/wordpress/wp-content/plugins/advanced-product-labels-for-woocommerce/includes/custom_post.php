...
class BeRocket_advanced_labels_custom_post extends BeRocket_custom_post_class {
    ...
    public $conditions, $templates, $templates_hide, $templates_rotate;
                ...
                'Style'     => array(
                    ...
                    'image_height' => array(
                        ...
                        "items" => array(
                            ...
                            $this->select_untis( 'image_height' ),
                        ),
                    ),
                    'image_width' => array(
                    ...
                    'border_radius' => array(
                        ...
                        "items" => array(
                            ...
                            $this->select_untis( 'border_radius' ),
                        ),
                    ),
                ),
                'Position'     => array(
                    ...
                    'padding_top' => array(
                        ...
                        "items" => array(
                            'value' => array(
                                ...
                                "name"     => "padding_top",
                                "extra"    => " data-for='.br_alabel' data-style='top' data-ext='{$options['padding_top_units']}'",
                                "value"    => $options['padding_top'],
                            ),
                            $this->select_untis( 'padding_top' ),
                        ),
                    ),
                    'padding_horizontal' => array(
                        ...
                        "items" => array(
                            'value' => array(
                                ...
                                "extra"    => " data-for='.br_alabel' data-from='.pos_label' data-ext='{$options['padding_horizontal_units']}'",
                                "value"    => $options['padding_horizontal'],
                            ),
                            $this->select_untis( 'padding_horizontal' ),
                        ),
                    ),
                    'position' => array(
                        "type"     => "selectbox",
